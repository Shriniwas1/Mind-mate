...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen text-slate-900 font-sans bg-[#F8FAFC]">
      ...
      <nav className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-slate-100 sticky top-0 bg-white/80 backdrop-blur-md z-50">
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-2.5 font-bold text-lg tracking-tight">
            ...
            <span className="font-extrabold text-xl bg-gradient-to-r from-indigo-600 to-violet-500 bg-clip-text text-transparent">MindMate</span>
          </div>
          <div className="hidden md:flex gap-6 text-base font-bold text-slate-500">
            <a href="#working" className="hover:text-indigo-600 transition-colors">Technology</a>
            <a href="#samples" className="hover:text-indigo-600 transition-colors">Preview</a>
        ...
        <motion.section {...fadeIn} className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={title} className="p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                <Icon className="text-indigo-600 w-4 h-4 mb-2.5" />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {features.map((f, i) => (
              <motion.div
                ...
                className="p-7 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow"
              >
        ...
        <motion.section id="samples" {...fadeIn} className="space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-slate-200 shadow-lg">
            ...
            <div className="bg-slate-900 p-8 text-white flex flex-col justify-center">
              <span className="text-xs font-mono text-indigo-400 uppercase tracking-widest mb-5 font-bold">AI Insights Engine</span>
              <div className="space-y-3.5">
                <div className="flex justify-between border-b border-white/10 pb-3">
                  <span className="text-base text-slate-400 font-semibold">Detected Stress</span>
                  <span className="text-base text-indigo-400 font-extrabold">High (Linguistic)</span>
                </div>
                <div className="flex justify-between border-b border-white/10 pb-3">
                ...
                <div className="mt-4 p-4 bg-indigo-500/15 rounded-xl border border-indigo-500/20 text-base">
                  <strong className="text-indigo-400">Recommendation:</strong> <span className="text-slate-300">5-minute Box Breathing & Priority Reset.</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative border-l-2 border-slate-200 ml-4 md:ml-0 md:flex md:border-l-0 md:border-t-2 md:pt-8 md:justify-between">
            {[
              ...
              <div key={i} className="mb-10 ml-6 md:ml-0 md:w-1/4">
                <div className="absolute -left-[9px] md:left-auto md:-top-[9px] w-4 h-4 bg-indigo-600 rounded-full" style={{ boxShadow: '0 0 0 4px rgba(79, 70, 229, 0.15)' }} />
                <h4 className="font-bold text-slate-800">{m.title}</h4>
                <p className="text-sm text-indigo-600 font-mono font-bold mb-1.5 mt-0.5">{m.date}</p>
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <ul className="space-y-4">
              <li className="flex gap-3.5 text-slate-300">
                <Zap className="text-indigo-400 w-5 h-5 shrink-0 mt-0.5" />
              ...
              <li className="flex gap-3.5 text-slate-300">
                <Database className="text-indigo-400 w-5 h-5 shrink-0 mt-0.5" />
              ...
              <li className="flex gap-3.5 text-slate-300">
                <Lock className="text-indigo-400 w-5 h-5 shrink-0 mt-0.5" />
      ...
      {/* Footer */}
      <footer className="px-6 py-10 border-t border-slate-100 text-base text-slate-500 flex flex-col md:flex-row justify-between items-center gap-6 font-medium">
        <div className="flex items-center gap-2">
          <img src="/mindmate-logo.png" alt="MindMate" className="w-6 h-6 rounded-lg object-contain" />
          <span className="font-extrabold bg-gradient-to-r from-indigo-600 to-violet-500 bg-clip-text text-transparent">MindMate</span>
        </div>
            ...
            >
              ...
              <div className="p-8 md:p-12 space-y-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="p-6 bg-slate-50 rounded-xl border border-slate-100">
                      <h4 className="font-bold mb-2 flex items-center gap-2 text-slate-800">
                        <Camera className="w-4 h-4 text-indigo-600" /> Facial Landmark Analysis
                      </h4>
                    ...
                    <div className="p-6 bg-slate-50 rounded-xl border border-slate-100">
                      <h4 className="font-bold mb-2 flex items-center gap-2 text-slate-800">
                        <Brain className="w-4 h-4 text-indigo-600" /> NLP Sentiment Engine
                      </h4>
                  ...
                  <div className="p-6 bg-slate-50 rounded-xl border border-slate-100">
                    <h4 className="font-bold mb-2 flex items-center gap-2 text-slate-800">
                        <Milestone className="w-4 h-4 text-indigo-600" /> The Weighting Algorithm
                    </h4>
                    <p className="text-slate-650 text-base leading-relaxed">
